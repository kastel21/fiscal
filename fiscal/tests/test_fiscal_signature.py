...
class FiscalCanonicalBuilderTests(TestCase):
    ...
    def test_counters_sorted(self):
        ...
        counters = [
            ...
            {"fiscalCounterType": "saleByTax", "fiscalCounterCurrency": "ZWL", "fiscalCounterTaxID": 1, "fiscalCounterValue": 20},
        ...
        # Sort: creditNoteByTax, saleByTax (alphabetically); then currency USD before ZWL; then taxID 1 before 2
        # creditNoteByTax USD 2: 1000 cents
        # saleByTax USD 1: 3000 cents
        # saleByTax ZWL 1: 2000 cents
        self.assertIn("CREDITNOTEBYTAX", canonical)
        self.assertIn("SALEBYTAX", canonical)
        # Order should be CREDITNOTEBYTAX first, then SALEBYTAX USD, then SALEBYTAX ZWL
    ...
    def test_tax_percent_formatting(self):
        ...
        counters = [
            ...
            {"fiscalCounterType": "saleByTax", "fiscalCounterCurrency": "ZWL", "fiscalCounterTaxPercent": 14.5, "fiscalCounterValue": 1},
        ]
        canonical = build_fiscal_day_canonical_string(
            device_id=1,
            fiscal_day_no=1,

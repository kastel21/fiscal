...
def api_dashboard_summary(request):
    ...
    if device_id and str(device_id).isdigit():
        ...
        device_id = None
    data = get_summary(device_id, range_key)
...
def api_dashboard_receipts(request):
    ...
    if device_id and str(device_id).isdigit():
        ...
        device_id = None
    receipts = get_receipts(device_id, range_key, status_filter)
...
def api_dashboard_errors(request):
    ...
    if device_id and str(device_id).isdigit():
        ...
        device_id = None
    errors = get_errors(device_id, range_key)
